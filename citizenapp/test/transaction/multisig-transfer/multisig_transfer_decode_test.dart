...
void main() {
  ...
  // 链上 VotingEngine::ProposalData[0] 布局回归样本：
  // Compact(142) + "multisig-transfer" + institution(32) + beneficiary(32)
  // + amount u128 LE(16) + remark Vec(Compact(12)+「转账测试」) + proposer(32)
  const onchainProposalDataHex = '0x39026d756c74697369672d7472616e73666572b38e'
