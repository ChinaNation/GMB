...
typedef ImSendAttachmentCallback = Future<void> Function(
  ImAttachmentDraft attachment,
);
typedef ImSyncCallback = Future<int> Function();
typedef ImStartRealtimeCallback = Future<Future<void> Function()?> Function({
  required Future<void> Function() onNotice,
  Future<void> Function()? onDisconnected,
});
typedef ImDownloadAttachmentCallback = Future<ImDownloadedAttachment> Function(
  String conversationId,
  String controlPlaintext,
);
typedef ImPickAttachmentCallback = Future<ImAttachmentDraft?> Function();
typedef ImDeleteConversationCallback = Future<void> Function();
...
class ImChatPage extends StatefulWidget {
  ...
  final ImSendAttachmentCallback? onSendAttachment;
  final ImDownloadAttachmentCallback? onDownloadAttachment;
  final ImPickAttachmentCallback? pickAttachment;
  final ImSyncCallback? onSync;
  final ImStartRealtimeCallback? onStartRealtime;
  final ImDeleteConversationCallback? onDeleteConversation;
...
class _ImChatPageState extends State<ImChatPage> {
  ...
  Future<void> _handleMessageTap(
    ...
    if (metadata['message_kind'] != ImMessageKind.attachment.name) {
      return;
    }
...
Future<ImAttachmentDraft?> _pickAttachment() async {
