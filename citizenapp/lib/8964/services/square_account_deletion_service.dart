...
/// IM 私信历史 / 原生 P-256 设备子钥）。钱包与链上身份不受影响。
class SquareAccountDeletionService {
  ...
  Future<void> deleteAccount({
    ...
    await _api.deleteAccount(ownerAccount: ownerAccount, signAction: signAction);
    // 2. 服务端确认后清本地，做到零残留。
    await _profileCache.clear(ownerAccount);
    _api.clearSession(ownerAccount);
    await _imStore.clearAllForOwner(ownerAccount);
