...
class CidApiConfig {
  ...
  static const String environmentDefineName = 'CITIZENAPP_CID_ENV';
    ...
    switch (environment.trim()) {
      ...
      default:
        throw UnsupportedError(
          '$environmentDefineName 只允许 prod 或 dev_usb，禁止配置其他 CID 地址',
        );
    }
  }
  ...
  static String connectionErrorMessage(String baseUrl) {
    if (baseUrl == devUsbBaseUrl) {
      return '当前使用本地 USB 开发路径 $devUsbBaseUrl，请确认电脑 CID 后端已启动，并已执行 adb reverse tcp:8899 tcp:8899';
    }
    return '当前使用生产 CID 路径 $productionBaseUrl，请检查手机网络、HTTPS 证书或生产网关';
  }
}
