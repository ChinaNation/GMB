/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 6f4a681cb38c50eb36fb585c1b83a8c9)
...
interface __BaseEnv_CloudflareBindings {
	...
	CHAT_RELAY: R2Bucket;
	DB: D1Database;
	SQUARE_NOTIFY_QUEUE: Queue;
	STREAM: StreamBinding;
	SESSION_TTL_SECONDS: "86400";
	UPLOAD_TTL_SECONDS: "900";
	ARCHIVE_ENABLED: "0" | "1";
	ARCHIVE_LAPSE_DAYS: "90";
	MEMBERSHIP_RECONCILE_ENABLED: "1" | "0";
	CREATOR_RECONCILE_ENABLED: "1" | "0";
	MEMBERSHIP_RECONCILE_BATCH: "50";
	APNS_ENV: "sandbox" | "production";
	R2_BUCKET: "citizenapp-square-media-staging" | "citizenapp-square-media";
	IMAGES_URL: "https://imagedelivery.net/UOEmEDe-GxX_DiS70z3GIg" | "";
	STREAM_URL: "https://customer-e3w478wvlbq2nl3g.cloudflarestream.com" | "";
	MEDIA_TTL_SECONDS: "300";
	WEB_ORIGIN: "https://www.crcfrcn.com";
	TURNSTILE_SITEKEY: "0x4AAAAAAD0GQRiB2O3a0DYJ";
	TOPUP_NETWORK: "mainnet" | "testnet";
	TOPUP_RECV_ADDRESS: "0x5ce9b56b9d1812a7cf29841e21756f09ca7d223b" | "";
	TOPUP_BASE_RPC_URL: "https://mainnet.base.org" | "";
	TOPUP_USDC_CONTRACT: "0x833589fcd6edb6e08f4c7c32d4f71b54bda02913" | "";
	TOPUP_USDT_CONTRACT: "0xfde4c96c8593536e31f229ea8f37b2ada2699bb2" | "";
	...
	CHAIN_GENESIS_HASH: "0xe8f4067de2323dc27b2a2c409fa4b3ab882e4e88dfa6f4a81355f51f8cf8eb45";
	CHAIN_STATE_ROOT: "0xbdc2593a538b7010717ac475b0b59973dd57c77d35683c4e7d9b8058b9ae18f9";
	RELAY_ENABLED: "0";
	...
	CHAT_REALTIME: DurableObjectNamespace<import("./src/index").ChatRealtimeObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatRealtimeObject";
	}
	interface StagingEnv {
		...
		MEMBERSHIP_RECONCILE_BATCH: "50";
		APNS_ENV: "sandbox";
		R2_BUCKET: "citizenapp-square-media-staging";
		IMAGES_URL: "https://imagedelivery.net/UOEmEDe-GxX_DiS70z3GIg";
		STREAM_URL: "https://customer-e3w478wvlbq2nl3g.cloudflarestream.com";
		MEDIA_TTL_SECONDS: "300";
		WEB_ORIGIN: "https://www.crcfrcn.com";
	...
	interface ProductionEnv {
		...
		MEMBERSHIP_RECONCILE_BATCH: "50";
		APNS_ENV: "production";
		R2_BUCKET: "citizenapp-square-media";
		TOPUP_NETWORK: "mainnet";
		TOPUP_RECV_ADDRESS: "0x5ce9b56b9d1812a7cf29841e21756f09ca7d223b";
		TOPUP_BASE_RPC_URL: "https://mainnet.base.org";
		TOPUP_USDC_CONTRACT: "";
