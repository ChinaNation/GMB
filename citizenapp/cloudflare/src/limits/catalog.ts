...
const routeLimits: readonly RouteLimit[] = [
  ...
  route('POST', /^\/square\/account\/delete(?:\/challenge)?$/),
  ...
  route('PUT', /^\/square\/uploads\/media$/, 'square_image_hd'),
  route('POST', /^\/square\/uploads\/complete$/),
  route('POST', /^\/square\/uploads\/stream\/webhook$/, 'stream_webhook'),
  ...
  route('POST', /^\/square\/signals$/),
  route('POST', /^\/chat\/devices\/register$/, 'chat_device'),
  route('POST', /^\/chat\/keypackages$/, 'chat_keypackage'),
  route('POST', /^\/chat\/keypackages\/consume$/),
  route('GET', /^\/chat\/keypackages\/[^/]+$/),
  route('POST', /^\/chat\/envelopes$/, 'chat_envelope'),
  route('POST', /^\/chat\/signals$/, 'chat_signal'),
  route('GET', /^\/chat\/ws$/),
  route('POST', /^\/chat\/relay\/init$/, 'chat_relay'),
  route('PUT', /^\/chat\/relay\/[^/]+\/blob$/, 'chat_relay_blob'),
  route('GET', /^\/chat\/relay\/[^/]+\/blob$/),
  route('POST', /^\/chat\/relay\/[^/]+\/ack$/),
];
