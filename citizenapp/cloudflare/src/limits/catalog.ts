...
const routeLimits: readonly RouteLimit[] = [
  ...
  route('POST', /^\/v1\/square\/topup\/status$/),
  route('GET', /^\/v1\/square\/topup\/settlement\/pending$/),
  route('POST', /^\/v1\/square\/topup\/settlement\/[^/]+\/(claim|settled|exception)$/),
  route('GET', /^\/v1\/square\/creator\/(plan|overview)$/),
  route('GET', /^\/v1\/square\/creator\/plan\/[^/]+$/),
  route('POST', /^\/v1\/square\/creator\/plan$/, 'api_json'),
  route('POST', /^\/v1\/square\/creator\/subscription\/confirm$/),
  ...
  route('GET', /^\/v1\/square\/posts\/self$/),
  ...
  route('PUT', /^\/v1\/square\/follows\/[^/]+\/notify$/),
  route('DELETE', /^\/v1\/square\/follows\/[^/]+$/),
  route('GET', /^\/v1\/square\/notify\/unread$/),
  route('POST', /^\/v1\/square\/notify\/read$/),
