...
## 1.1.功能需求
### 1.1.1.高优级功能
* 管理员身份登录：国储会：使用公钥登录；省储会：使用公钥登录；省储行：使用公钥登录。
...
### 1.1.2.中优级功能
* 治理：国储会：决议发行提案/投票、增删改新省储会/省储行提案/投票、决议销毁提案/投票；省储会：决议发行投票、决议销毁提案投票；省储行：决议发行投票、决议销毁提案投票。
...
└─ frontend/                     # 所有节点前端统一放在这个文件夹
    └─ manage-frontend/          # 管理端前端（manage是前端管理软件，国储会、省储会、省储行共用的前端软件）
