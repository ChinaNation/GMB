...
export interface WuminSignaturePanelProps {
  qrTitle?: string;
  scannerTitle?: string;
  qrValue?: string | null;
...
export function WuminSignaturePanel({
  qrTitle = '签名二维码',
  scannerTitle = '扫码窗口',
  qrValue,
  qrPlaceholderValue = 'SFID_SIGN_PENDING',
  qrHint,
