...
impl PendingKind {
    ...
    pub(crate) fn call_index(self) -> u8 {
        match self {
            PendingKind::AddBackup => {
                crate::app_core::chain_client::CALL_INDEX_ADD_SHENG_ADMIN_BACKUP
            }
            PendingKind::RemoveBackup => {
                crate::app_core::chain_client::CALL_INDEX_REMOVE_SHENG_ADMIN_BACKUP
            }
            PendingKind::ActivateSigning => {
                crate::app_core::chain_client::CALL_INDEX_ACTIVATE_SHENG_SIGNING
            }
            PendingKind::RotateSigning => {
                crate::app_core::chain_client::CALL_INDEX_ROTATE_SHENG_SIGNING
            }
        }
    }
