...
pub(crate) mod city_admins;
/// 中文注释:内置初始联邦管理员公钥与省份归属清单。
pub(crate) mod federal_admins;
/// 中文注释:管理员登录认证能力,归入 admins 边界。
pub(crate) mod login;
/// 中文注释:联邦管理员/市管理员实体、角色和列表 DTO。
pub(crate) mod model;
/// 中文注释:管理端操作权限分级唯一入口。
...
pub(crate) use catalog::list_federal_admins;
pub(crate) use city_admins::list_city_admins;
