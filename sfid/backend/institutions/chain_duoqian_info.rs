...
//!   - `GET /api/v1/app/institutions/:sfid_id/registration-info` 链端注册信息凭证
...
#[path = "chain_duoqian_info_dto.rs"]
mod dto;
#[path = "chain_duoqian_info_handler.rs"]
mod handler;

pub(crate) use handler::{
    app_get_institution, app_get_institution_registration_info, app_list_accounts,
    app_search_clearing_banks, app_search_eligible_clearing_banks, app_search_institutions,
};
