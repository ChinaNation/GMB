//! DUOQIAN_V1 机构账户地址派生。
//!
//! 与链端 `citizenchain/runtime/transaction/organization-manage/src/lib.rs`
...
//! - `organization-manage/src/lib.rs:1199-1223`:`derive_institution_address`
//! - `organization-manage/src/lib.rs:1234-1247`:`role_from_account_name`
