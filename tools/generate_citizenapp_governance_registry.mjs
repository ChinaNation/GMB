...
const outPath = path.join(
  repoRoot,
  'citizenapp/lib/governance/organization-manage/governance_institution_registry.generated.dart',
);
...
console.log(`generated ${path.relative(repoRoot, citizenwalletOutPath)} (${cbItems.length + chItems.length} institutions)`);
