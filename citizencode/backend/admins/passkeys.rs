...
const PROD_PASSKEY_RP_ID: &str = "cid.crcfrcn.com";
const PROD_PASSKEY_ORIGIN: &str = "https://cid.crcfrcn.com";
const DEV_PASSKEY_RP_ID: &str = "localhost";
const DEV_PASSKEY_ORIGIN: &str = "http://localhost:5179";
const ENV_PASSKEY_RP_ID: &str = "CID_PASSKEY_RP_ID";
const ENV_PASSKEY_ORIGIN: &str = "CID_PASSKEY_ORIGIN";
const ENV_PASSKEY_ALLOWED_ORIGINS: &str = "CID_PASSKEY_ALLOWED_ORIGINS";
