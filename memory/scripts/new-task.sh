...
template_file_for_module() {
  ...
  case "$module" in
    ...
    citizenchain/node)
      ...
      ;;
    citizencode|citizencode/backend|citizencode/deploy)
      printf '%s' "memory/08-tasks/templates/citizencode-backend.md"
      ;;
    citizencode/frontend)
      printf '%s' "memory/08-tasks/templates/citizencode-frontend.md"
      ;;
    citizenpassport|citizenpassport/backend|citizenpassport/deploy)
      printf '%s' "memory/08-tasks/templates/citizenpassport-backend.md"
      ;;
    citizenpassport/frontend)
      printf '%s' "memory/08-tasks/templates/citizenpassport-frontend.md"
      ;;
    citizenapp|citizenapp/lib)
      printf '%s' "memory/08-tasks/templates/citizenapp.md"
      ;;
    primitives)
...
checklist_file_for_module() {
  ...
  case "$module" in
    ai/system)
      ...
      ;;
    citizenchain/runtime|citizenchain/governance|citizenchain/issuance|citizenchain/otherpallet|citizenchain/transaction|citizenchain/node|primitives)
      printf '%s' "memory/07-ai/module-checklists/citizenchain.md"
      ;;
    citizencode|citizencode/backend|citizencode/frontend|citizencode/deploy)
      printf '%s' "memory/07-ai/module-checklists/citizencode.md"
      ;;
    citizenpassport|citizenpassport/backend|citizenpassport/frontend|citizenpassport/deploy)
      printf '%s' "memory/07-ai/module-checklists/citizenpassport.md"
      ;;
    citizenapp|citizenapp/lib)
      printf '%s' "memory/07-ai/module-checklists/citizenapp.md"
      ;;
    *)
      printf '%s' ""
      ;;
...
dod_file_for_module() {
  ...
  case "$module" in
    ...
    citizenchain/runtime|citizenchain/governance|citizenchain/issuance|citizenchain/otherpallet|citizenchain/transaction|citizenchain/node|primitives)
      ...
      ;;
    citizencode|citizencode/backend|citizencode/frontend|citizencode/deploy)
      printf '%s' "memory/07-ai/module-definition-of-done/citizencode.md"
      ;;
    citizenpassport|citizenpassport/backend|citizenpassport/frontend|citizenpassport/deploy)
      printf '%s' "memory/07-ai/module-definition-of-done/citizenpassport.md"
      ;;
    citizenapp|citizenapp/lib)
      printf '%s' "memory/07-ai/module-definition-of-done/citizenapp.md"
      ;;
    *)
      printf '%s' ""
      ;;
...
write_context_block() {
  ...
  case "$module" in
    ...
    citizenchain/node)
      ...
      ;;
    citizencode|citizencode/backend|citizencode/frontend|citizencode/deploy)
      append_line "$file" "- citizencode/README.md"
      append_line "$file" "- citizencode/CID_TECHNICAL.md"
      ;;
    citizenpassport|citizenpassport/backend|citizenpassport/frontend|citizenpassport/deploy)
      append_line "$file" "- citizenpassport/README.md"
      append_line "$file" "- citizenpassport/CITIZENPASSPORT_TECHNICAL.md"
      ;;
    citizenapp|citizenapp/lib)
      append_line "$file" "- citizenapp/CITIZENAPP_TECHNICAL.md"
      ;;
    primitives)
      append_line "$file" "- memory/01-architecture/citizenchain-target-structure.md"
      append_line "$file" "- citizenchain/CITIZENCHAIN_TECHNICAL.md"
