...
case "$MODULE" in
  ...
  citizenchain/runtime/otherpallet/cid-system|citizenchain/otherpallet/cid-system|cid-system)
    ...
    print_if_exists "citizenchain/CITIZENCHAIN_TECHNICAL.md"
    print_if_exists "citizenchain/runtime/README.md"
    print_if_exists "memory/05-modules/citizenchain/runtime/otherpallet/cid-system/CID_SYSTEM_TECHNICAL.md"
    ;;
  ...
  citizenchain/runtime/votingengine|votingengine)
    ...
    print_if_exists "citizenchain/CITIZENCHAIN_TECHNICAL.md"
    print_if_exists "citizenchain/runtime/README.md"
    print_if_exists "memory/05-modules/citizenchain/runtime/votingengine/VOTINGENGINE_TECHNICAL.md"
    ;;
  ...
  citizencode|citizencode/backend|citizencode/frontend|citizencode/deploy)
    print_base_context
    print_if_exists "citizencode/README.md"
    print_if_exists "citizencode/CID_TECHNICAL.md"
    print_if_exists "memory/05-modules/citizencode/backend/BACKEND_LAYOUT.md"
    print_if_exists "memory/05-modules/citizencode/backend/business/BUSINESS_TECHNICAL.md"
    ;;
  citizenpassport|citizenpassport/backend|citizenpassport/frontend|citizenpassport/deploy)
    print_base_context
    print_if_exists "citizenpassport/README.md"
    print_if_exists "citizenpassport/CITIZENPASSPORT_TECHNICAL.md"
    ;;
  citizenapp|citizenapp/lib)
    print_base_context
    print_if_exists "citizenapp/CITIZENAPP_TECHNICAL.md"
    ;;
  primitives)
    print_base_context
    print_if_exists "memory/01-architecture/citizenchain-target-structure.md"
