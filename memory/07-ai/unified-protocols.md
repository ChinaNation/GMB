...
- 详细文档：
  ...
  - `memory/01-architecture/qr/qr-action-registry.md`
- 生产者：
  - `wuminapp/lib/organization-manage/duoqian_manage_service.dart`
...
- 消费者：
  ...
  - `citizenchain/node`
  - `wuminapp/lib/common/admin_institution_codec.dart`
- 字段：
  - key：`SubjectId`
...
- 消费者：
  ...
  - `wuminapp/lib/organization-manage/duoqian_storage_codec.dart`
- 字段：
  - key1：`sfid_number`
  - key2：`account_name`
