...
| 字段 | 含义 | 来源 |
|---|---|---|
| `province_code` | 所属省代码 | `citizenchain/registry/src/cid/china/china.sqlite` 的 `provinces.code` |
| `city_code` | 所属市代码 | `citizenchain/registry/src/cid/china/china.sqlite` 的 `cities.code` |
| `town_code` | 所属镇代码 | `citizenchain/registry/src/cid/china/china.sqlite` 的 `towns.code`；非镇级机构为空 |
