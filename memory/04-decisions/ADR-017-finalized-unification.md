...
- 状态:Proposed(2026-06-12,user 已确认方向,待逐卡实施)
...
6. **权威**:开发期单权威 = 国储会节点(中枢),它是全网 finality 心脏,须存活监控;运行期 44 权威需 2/3+1=30 票在线,**部署算术问题必须在 SwitchToProduction 之前定案**(6 台服务器装不下 30 个 voter 身份)。
