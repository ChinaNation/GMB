...
- `citizenchain/node/src/ui/node_runner.rs`
- `citizenchain/node/src/ui/home/process/mod.rs`
- `citizenchain/node/src/ui/settings/bootnodes-address/mod.rs`
...
- `citizenchain/node/src/ui/settings/bootnodes-address/mod.rs:25-40`
  `BootnodeKey` / `GenesisBootnodeOption` 都围绕 PeerId 与机构映射
- `citizenchain/node/src/ui/settings/bootnodes-address/mod.rs:142-159`
  实际写入的是本机 `node-key/secret_ed25519`
- `citizenchain/node/src/ui/settings/bootnodes-address/mod.rs:223-243`
