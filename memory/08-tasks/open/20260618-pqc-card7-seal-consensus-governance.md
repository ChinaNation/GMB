...
1. **seal 共识签名 ML-DSA-65(BLOCKER B13:非 setCode)**:
   ...
   - 🔴 **(v5 创世边界)seal 明确排除永久创世冻结**:seal 在 node 二进制、**不进 chainspec/runtime/genesis state** → 切 ML-DSA **不受创世冻结约束、无需重新创世**,创世前 seal 仍是 sr25519 **不烘进骨架**,创世后任意时间窗经本卡协调二进制升级(激活高度+import 双接受窗口)完成。
