...
- [ ] 迁移现有个人多签调用方 import 到 shared,删旧 `personal_account_derive.dart`,零行为变化。
...
- [ ] 旧 personal_account_derive.dart 零引用、已删。
...
- 删 `citizenapp/lib/governance/personal-manage/personal_account_derive.dart`:归位后清残留。
