...
- 前端：改造 `citizenpassport/frontend/dangan/ArchiveDetail.tsx` 的详情页布局。
...
- 2026-06-13：更新 `citizenpassport/CITIZENPASSPORT_TECHNICAL.md` 与 `memory/05-modules/citizenpassport/backend/dangan/DANGAN_TECHNICAL.md`，清理资料库旧上下堆叠展示口径。
