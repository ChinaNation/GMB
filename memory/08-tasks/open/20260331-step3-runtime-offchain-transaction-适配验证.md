# 第3步：runtime offchain-transaction 模块适配验证
...
验证现有 offchain-transaction 模块的批量清算逻辑是否完全满足省储行即时清算交易的需求，做必要微调。
...
- `citizenchain/runtime/transaction/offchain-transaction/src/lib.rs` — 主模块
- `citizenchain/runtime/transaction/institution-asset/src/lib.rs` — 可能微调
