...
- 结构改动：头图 ~112px（不再 300px 整块压资料）；头像 76px 圆角方形跨压头图下缘（一半在图一半在白底）；昵称+认证勾 / 地址+复制·CID / 个性签名 / 关注·关注者·帖子 全部深色字落在头图下方白底；上滑虚化+返回+⋮+居中标题、分类标签(帖子/竞选/照片/视频/文章) sticky（决策 6 保留）；⋮ 菜单本人=二维码/编辑资料、他人=二维码。
