# 任务卡：wuminapp 转账提案批量解码 48 字节旧主体残留守卫
...
- 全仓扫描:此 `48` 残留仅此一处(chain_tx_monitor:608 的 48 = 32+16 合法组合;wumin 无残留)。
...
- 全仓扫描确认 48 字节主体残留仅此一处(wumin 零残留;chain_tx_monitor:608 的 48=32+16 合法)。
