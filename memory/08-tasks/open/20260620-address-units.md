...
- 本任务不修改 `citizenchain/runtime/**`,不生成 citizenapp 公权机构包,不生成 SFID 公权机构。
...
- 2026-06-20:已通过当前 SFID 真实公开接口重新生成 `citizenapp/assets/public_institutions/`,manifest `version=1`,43 省,共 245716 条公民端公权机构,包含 `CITY_POLICE=2872`、`CITY_EDU=2872`、`JY=2873`、`PUBLIC_SECURITY=2872`;资产包 code 交叉检查 `bad_count=0`。
