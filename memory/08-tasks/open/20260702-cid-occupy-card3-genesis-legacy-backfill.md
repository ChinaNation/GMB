...
- genesis 直铸 296 + 49,297 = 49,593,构建期断言全过;genesis 测试断言数量与「常量数组 + 省/市×码表」推导值逐一一致。
...
- 创世后链上 Institutions 总数 = 49,593(常量 296 + 模板派生 49,297),与推导值一致(genesis 测试断言);内置号 100% 通过 parse 校验。
