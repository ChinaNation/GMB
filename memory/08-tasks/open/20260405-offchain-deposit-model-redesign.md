...
- **日期**: 2026-04-05
- **版本**: v2.0
- **状态**: **superseded**(2026-04-19 被 `memory/08-tasks/open/20260419-扫码支付-step1-同行MVP.md` 替代)

> 本任务卡的"省储行直接清算"模型已在 2026-04-19 的需求迭代中被放弃,替换为"清算行(L2)承担清算、省储行退出清算"的新架构。本文档作为历史参考保留,不再执行其中方案。最新方案详见:
