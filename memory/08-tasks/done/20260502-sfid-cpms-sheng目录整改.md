...
sfid/backend/sheng_admins/         # 中文注释:只保留联邦管理员/市管理员治理与联邦管理员必要链交互
sfid/frontend/sheng_admins/        # 中文注释:只保留联邦管理员/市管理员页面和联邦管理员必要链交互
...
- 联邦管理员本人签名密钥生成/更换是 SFID 本地 seed 生命周期,不是链交互,不得使用 `chain_` 文件名。
