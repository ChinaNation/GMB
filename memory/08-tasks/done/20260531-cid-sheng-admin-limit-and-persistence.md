...
- CID 当前代码和技术文档不再出现 `super_admin / SuperAdmin / super-admin / SUPER_ADMIN` 残留。
- 后端检查、测试和前端构建通过。
...
- `rg` 检查 CID 后端、管理员前端、CID 技术文档，没有 `super_admin / SuperAdmin / super-admin / SUPER_ADMIN / 006_super_admin_catalog / SuperAdminSubTab` 残留。
