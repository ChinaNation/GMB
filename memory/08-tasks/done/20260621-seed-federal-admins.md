...
> **⚠️ 已退役(2026-06-30 更新)**:本卡的 `seed-federal-admins` CLI + 215 平铺本地播种 + `federal_registry_scope` 表已全部删除。FRG 管理员改「全走链读」链上 `PublicAdmins::FederalRegistryProvinceGroups[省码]`(每节点单省)。
