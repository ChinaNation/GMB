# 任务卡：把 Codex 主窗口自动调度 Blockchain Agent / CID Agent / CPMS Agent / Mobile Agent 的机制写入 AI 编程系统，明确用户只需在 Codex 用中文提需求，系统按需自动分工并回写 memory
...
把 Codex 主窗口自动调度 Blockchain Agent / CID Agent / CPMS Agent / Mobile Agent 的机制写入 AI 编程系统，明确用户只需在 Codex 用中文提需求，系统按需自动分工并回写 memory
