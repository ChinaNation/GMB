...
- `sfid/backend/sheng_admins/institutions.rs::submit_register_sfid_institution_extrinsic`
...
- `sfid/backend/app_core/chain_runtime.rs`
  - `INSTITUTION_DOMAIN: [u8; 23] = *b"GMB_SFID_INSTITUTION_V2"`（之前是 `&[u8]`；该域名已于 2026-04-20 彻底退役，改用 `DUOQIAN + OP_SIGN_INST`）
