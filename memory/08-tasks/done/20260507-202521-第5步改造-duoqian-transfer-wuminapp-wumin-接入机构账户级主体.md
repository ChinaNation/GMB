...
先执行第5步，改造 duoqian-transfer 多签转账、wuminapp 在线端、wumin 公民钱包，统一接入 InstitutionAccount AccountId 机构账户级内部投票主体；保持一人一票一笔交易；完成文档、注释、残留清理，且不修改 spec_version。第4步 organization-manage 后续再执行。
...
- 已完成 wumin 公民钱包解码：`propose_transfer` 仅接受 `0x01 / 0x03 / 0x05` 可支出主体，拒绝旧裸 sfid 与 `0x02`；`propose_sweep_to_main` 只接受 `0x01 BuiltinInstitution`。
