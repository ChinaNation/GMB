# 任务卡：修复 nodeui 挖矿页面收益统计口径，按区块当时的真实到账规则显示矿工实际收益：未绑定奖励钱包时手续费应视为销毁且不计入矿工收益、铸块奖励计入矿工自身账户；已绑定时手续费 80% 与铸块奖励按链上实际收款钱包统计，并同步调整页面文案、缓存迁移与模块文档。
...
修复 nodeui 挖矿页面收益统计口径，按区块当时的真实到账规则显示矿工实际收益：未绑定奖励钱包时手续费应视为销毁且不计入矿工收益、铸块奖励计入矿工自身账户；已绑定时手续费 80% 与铸块奖励按链上实际收款钱包统计，并同步调整页面文案、缓存迁移与模块文档。
...
- 已将 nodeui 挖矿页统计口径改为“实际到账收益”，并同步调整缓存迁移、页面标签与模块文档。
