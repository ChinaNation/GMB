...
- 追补(2026-06-21)：统一 `scripts/duoqian.py` 与 BLAKE2 派生文档中 OP_AN/OP_HE 的 payload 表述，二者均为国家储委会 `cid_number`；同时补齐文档表格中的 `OP_HE=0x04`，恢复 `OP_PERSONAL=0x05`、`OP_INSTITUTION=0x06` 编号。
