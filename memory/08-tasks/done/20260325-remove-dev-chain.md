...
- 状态：in-progress
- 所属模块：citizenchain-node, citizenchain-runtime, citizenchain-nodeui
...
- `nodeui/backend/build.rs`：删除 dev-chain 条件编译
- `nodeui/backend/src/home/process/mod.rs`：删除 `--chain dev`
...
| `nodeui/backend/Cargo.toml` | 删 dev-chain feature |
...
| `nodeui/backend/build.rs` | 删 dev-chain 条件 |
| `nodeui/backend/src/home/process/mod.rs` | 删 --chain dev |
