...
- `memory/08-tasks/open/20260524-myid-validity-sfid-citizenapp.md`
- `memory/08-tasks/open/20260524-network-cards-cleanup.md`
- `memory/08-tasks/open/20260524-sfid-archive-code-ui.md`
- `memory/08-tasks/open/20260524-citizenapp-sfid-two-paths.md`
...
- `memory/08-tasks/open/20260613-sfid-citizenapp-bff-public-catalog.md`
...
- `memory/08-tasks/done/20260325-150802-为-sfid-机构生成流程新增独立机构名称字段并用于-citizenapp-与-citizenwallet-显示.md`
...
- `memory/08-tasks/done/20260329-100000-citizenwallet-citizenapp-扫码登录-sfid-cpms.md`
...
- `memory/08-tasks/done/20260615-sfid-village-unify-cun-lu-classify.md`
...
- `memory/08-tasks/done/20260618-sfid-admin-district-management.md`
