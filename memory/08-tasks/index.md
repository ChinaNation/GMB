...
- `memory/08-tasks/open/20260612-wuminapp-run-adb-preflight.md`
...
- `memory/08-tasks/open/20260614-wuminapp-public-institution-detail-align-governance.md`
...
- `memory/08-tasks/open/20260618-wuminapp-admin-division-incremental-sync.md`
- `memory/08-tasks/done/20260619-admin-district-fresh-genesis-hk-zs.md`
- `memory/08-tasks/open/runtime-full-audit.md`

## done

- `memory/08-tasks/done/20260619-wuminapp-public-all-gov.md`
