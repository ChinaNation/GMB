...
| error_code | HTTP | 含义 |
|---|---:|---|
| `SFID_ADMIN_ACCOUNT_EXISTS_AS_FEDERAL_REGISTRY` | 409 | 管理员账户已作为联邦注册局管理员存在 |
| `SFID_ADMIN_ACCOUNT_EXISTS_AS_CITY_REGISTRY` | 409 | 管理员账户已作为市注册局管理员存在 |
| `SFID_ADMIN_FEDERAL_REGISTRY_PROVINCE_LIMIT_REACHED` | 409 | 本省联邦注册局管理员已达到 5 人上限 |
| `SFID_ADMIN_CITY_REGISTRY_CITY_LIMIT_REACHED` | 409 | 本市市注册局管理员已达到 30 人上限 |
