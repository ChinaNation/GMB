...
- 页面还会单独展示“本联邦管理员投票进度 / 本机构阈值”，避免把联合权重阈值和机构内部门限混淆。
...
2. **管理员身份标识**（仅管理员可见）：绿色提示条"你是本联邦管理员，点击上方卡片可发起提案"。
...
| 机构联合投票 | 钱包是当前联邦管理员，且该管理员尚未对本机构投票 | ✅ 已实现 |
