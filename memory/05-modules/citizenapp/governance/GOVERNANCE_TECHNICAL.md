...
| `lib/governance/admins-change/services/institution_admin_service.dart` | 管理员查询门面（委托 `AdminAccountService` 按机构码读取对应管理员 pallet 的 `AdminAccounts`） |
...
| `lib/personal-manage` | 个人多签层（个人列表、详情、发现、创建、关闭、管理员激活、提案历史、PersonalAdmins 链上编解码） |
...
| `lib/governance/organization-manage/multisig_discovery_service.dart` | 机构多签反向索引发现服务 |
| `lib/governance/organization-manage/institution_multisig_models.dart` | 机构关闭提案模型与机构账户状态模型 |
...
| `lib/governance/organization-manage/institution_multisig_create_page.dart` | 机构多签创建表单 |
| `lib/governance/organization-manage/institution_multisig_close_page.dart` | 机构多签关闭表单 |
...
| `lib/governance/personal-manage/personal_manage_service.dart` | PersonalAdmins 个人多签链上交互服务 |
| `lib/governance/personal-manage/personal_manage_storage_codec.dart` | PersonalAdmins storage key 与 SCALE 解码 |
...
- `lib/governance/organization-manage/multisig_discovery_service.dart`
- `lib/governance/organization-manage/institution_multisig_models.dart`
- `lib/governance/organization-manage/account_manage_service.dart`
- `lib/governance/account_manage_detail_page.dart`
- `lib/governance/organization-manage/institution_multisig_create_page.dart`
- `lib/governance/organization-manage/institution_multisig_close_page.dart`
