...
| --- | --- | --- | --- | --- |
| 决议发行 | `propose_resolution_issuance` | `reason, total_amount, allocations[]` | 国家储委会 + 43 个省储委会管理员 | 联合+公民 |
| 协议升级 | `propose_runtime_upgrade` | `reason, code` | 国家储委会 + 43 个省储委会管理员 | 联合+公民 |
