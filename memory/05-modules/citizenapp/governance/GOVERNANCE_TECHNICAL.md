...
- QR call data：`[pallet][call][institution_code:[u8;4]][account_id:32][admins:Compact<Vec<AccountId32>>][new_threshold:u32_le]`；PMUL 走 `29.0`，创世管理员走 `12.0`，公权走 `27.0`，私权走 `28.0`，非法人按所属法人归属走 `27.0` 或 `28.0`。
