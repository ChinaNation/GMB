...
> 状态：CP-1~5 全部完成  
> 日期：2026-04-12  
> 模块：citizenapp（Dart）+ scripts（Shell）+ memory（文档）+ citizenchain/node（前端文案）  
...
**文件**：`citizenapp/lib/rpc/smoldot_client.dart`
...
**文件**：`citizenapp/lib/rpc/smoldot_client.dart:449-466`
