...
- 个人多签列表展示：统一由 `citizenapp/lib/governance/duoqian_account_list_page.dart` 与机构多签合并展示
...
- 个人/机构多签管理提案投票详情页：共用入口位于 `citizenapp/lib/governance/duoqian_manage_detail_page.dart`，本模块只提供 PersonalManage 解码服务。
