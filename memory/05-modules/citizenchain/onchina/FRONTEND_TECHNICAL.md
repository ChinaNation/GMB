...
2026-07-19 第 5B：公权/私权机构治理页面新增必填“提案发起岗位码”，平台调价页面同样独立提交 `proposer_role_code`（技术公司可预填 `GENESIS_PRODUCT_MANAGER`）。业务模块固定选择内部投票引擎，前端不得提供引擎选择器；管理员登录成功本身不代表拥有任何业务发起权限。
