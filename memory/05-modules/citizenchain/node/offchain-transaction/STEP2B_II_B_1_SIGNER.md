# citizenchain/node/src/transaction/offchain_transaction/settlement/signer.rs · Step 2b-ii-β-1 技术说明
...
- 依赖 `crate::transaction::offchain_transaction::keystore::SigningKey`。2026-04-29 二次目录收口后,密钥容器已迁入 `offchain/keystore.rs`,不再保留根级 `offchain_keystore.rs`。
...
- 2026-04-29:`SigningKey` 引用随目录收口改为 `crate::transaction::offchain_transaction::keystore::SigningKey`。
