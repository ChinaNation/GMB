...
- **日期**:2026-04-19
- **范围**:扫码支付 Step 2b-iii-b(`offchain/reserve.rs` 主账对账 + CLI flag + service.rs 启动)
...
本步的 `offchain::reserve` 就是这个保底:**周期性读链上单点值,对比本地 snapshot,偏差 log::error!**。
...
### 3.1 新增 `offchain/reserve.rs`(~190 行)
