# INSTITUTION_ASSET_GUARD_TECHNICAL

模块：`institution-asset-guard`  
...
### 2.2 InstitutionAssetGuard<AccountId>
...
### 4.1 duoqian-manage-pow

- `propose_close`
- `execute_close`

### 4.2 duoqian-transfer-pow

- `propose_transfer`
- `try_execute_transfer`

### 4.3 offchain-transaction-pos
