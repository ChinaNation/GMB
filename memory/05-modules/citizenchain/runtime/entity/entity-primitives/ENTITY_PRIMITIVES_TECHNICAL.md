...
- 跨端 SCALE 金标唯一文件为受保护测试资产 `memory/06-quality/fixtures/institution_role_permission.json`；Node 使用本 crate 共享类型逐字节解码，OnChina、CitizenApp、CitizenWallet 对同一金标严格解码并拒绝尾随字段。
