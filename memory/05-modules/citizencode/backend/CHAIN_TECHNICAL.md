...
| 职责 | 当前文件 |
|---|---|
| 机构查询、注册信息凭证、账户列表 DTO 与 handler | `citizencode/backend/subjects/chain_duoqian_info.rs` |
...
| `GET /api/v1/app/institutions/:cid_number` | `subjects::chain_duoqian_info::app_get_institution` |
| `GET /api/v1/app/institutions/:cid_number/registration-info` | `subjects::chain_duoqian_info::app_get_institution_registration_info` |
| `GET /api/v1/app/institutions/:cid_number/accounts` | `subjects::chain_duoqian_info::app_list_accounts` |
