# cid-frontend 模块化目录铁律

任务卡 `20260408-cid-frontend-app-tsx-split` 拆分后的强制约定:
...
- `citizencode/frontend/<feature>/README.md`
- 任务卡:`memory/08-tasks/done/20260408-cid-frontend-app-tsx-split.md`
