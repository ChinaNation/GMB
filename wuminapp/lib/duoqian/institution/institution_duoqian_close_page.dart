...
class InstitutionDuoqianClosePage extends StatefulWidget {
  const InstitutionDuoqianClosePage({
    super.key,
  ...
  @override
  State<InstitutionDuoqianClosePage> createState() =>
      _InstitutionDuoqianClosePageState();
}
