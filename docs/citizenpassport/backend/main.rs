...
async fn main() {
    ...
    println!("citizenpassport-backend listening on http://{}", addr);
...
mod tests {
    ...
    fn qr_signature_can_be_verified() {
        let payload =
            "cid-cpms-v1|archive|ABCDEFGHIJKLMNOPQRSTUVWXY2-Z7|NORMAL|true|2026-05-24|2036-05-23|0x1234|0xabcd";
        let secret = [9u8; 32];
