...
fn cpms_error_code(status: StatusCode, message: &str) -> &'static str {
    ...
    match message {
        ...
        "admin_account not found" => "CPMS_AUTH_ADMIN_NOT_FOUND",
        ...
        "invalid admin user_group" => "CPMS_ADMIN_USER_GROUP_INVALID",
        "admin name required" => "CPMS_ADMIN_NAME_REQUIRED",
        "admin name too long" => "CPMS_ADMIN_NAME_TOO_LONG",
        "admin limit reached" => "CPMS_ADMIN_LIMIT_REACHED",
        "initial admin cannot be deleted" => "CPMS_ADMIN_INITIAL_ADMIN_IMMUTABLE",
        "admin not found" => "CPMS_ADMIN_NOT_FOUND",
        "admin_account already exists" => "CPMS_ADMIN_PUBKEY_DUPLICATED",
