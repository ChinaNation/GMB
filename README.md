...
* 公民币区块链结构图
![alt text](https://raw.githubusercontent.com/ChinaNation/GMB/main/wendangku/公民币区块链结构图.png)
## 1.3.发行量概览
   |    发行类型      |            发行金额/简述            |         流通状态                    |                备注                      |
   |:---------------:|:---------------------------------:|:---------------------------------:|:----------------------------------------:|
   |   创世发行       |   1,443,497,378.00元(14.4349亿)     |    流通                            | 国储会持有                                |
   |   省储行创立发行  |   144,349,737,800.00元(1443.4973亿)  |   非流通/永久质押                   | 各省储行质押钱包持有                        |
   |   省储行质押发行  |   36,809,183,139.00元(368.0918亿)    |   逐年释放/共100年                   | 省储行质押发行智能合约持有                 |
   |   全节点发行     |   9,999,899,000.01元(99.9989亿)      |   逐区块释放/共9,999,999个区块        | 写入PoW共识                               |
   |   公民轻节点发行  |   1,571,981,633,622.00元(1.5719万亿)  |  逐节点释放/共1,443,497,378个节点    | 公民轻节点发行智能合约持有                |
...
![alt text](https://raw.githubusercontent.com/ChinaNation/GMB/main/wendangku/节点图.png)
## 2.2.国储会权威节点  
...
* 创世发行1,443,497,378.00元数字公民币（14.43亿元），创世发行量以中共第7次人口普查数据为基准，每一个中共国人发行1.00元数字公民币；
   |    中共第7次人口普查数据   |          创世发行量       |     国储会多签地址（公民币）       |      国储会USDT/USDC钱包地址(以太坊)            |
   |:-----------------------:|:-----------------------:|:---------------------------------:|:--------------------------------------------:|
...
* 创世发行1,443,497,378.00元数字公民币，兑换价格为每0.01U兑换1.00元数字公民币，即1U=100.00元数字公民币，预计融资额14,434,973.78U（1443.49万U），由国储会权威节点发行并持有；
* 资金用途
   |          项目                            |  预算金额（USDT）|
   |:---------------------------------------:|:---------------:|
   |各官网开发                                 |     50.00万     |
...
## 3.2.省储行创立发行
* 创立省储行节点的，即发行该省总人口数x100的数字公民币，各省人口以中共第7次人口普查数据为基准（已做省份调整），共计发行144,349,737,800元；  
...
* 各省储行创立发行的数字公民币永久质押于该省储行单签名账户地址，该地址在runtime中硬编码限制支出，只能转入不能转出；    
## 3.3.省储行质押发行
* 各省储行质押的数字公民币，由系统质押发行支付100年的质押利息,由质押发行智能合约在每年12月30日支付下一年度的质押利息，支付存入各省储行多签名地址；  
* 质押发行的数字公民币归各省储行所有，用于省储行运营和帮助各省的民运人士，在质押期满100年后，即永久停止质押发行，不再支付质押利息；  
...
* 所有获得公民轻节点认证发行的奖励，均处于锁定状态，在持有该轻节点的公民完成《公民素质教育法案》题库学习合格后，即可解锁奖励资金，公民轻节点发行智能合约自动发放奖励；  
