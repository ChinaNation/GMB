...
/// 在节点端的 SCALE 镜像。字段顺序必须与 [`citizenchain/runtime/transaction/organization-manage/src/institution/types.rs`]
...
/// 与 [`citizenchain/runtime/transaction/organization-manage/src/institution/types.rs::InstitutionLifecycleStatus`] 对齐。
