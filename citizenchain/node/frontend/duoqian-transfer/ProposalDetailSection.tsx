...
import type { DuoqianTransferProposalDetails } from './types';

type Props = {
  info: DuoqianTransferProposalDetails;
};

// 多签转账详情展示归 duoqian-transfer 模块维护，治理详情页只负责挂载。
export function DuoqianTransferProposalDetailSection({ info }: Props) {
  return (
    <>
      {info.transferDetail && (
