...
// `GenesisAdmins`(联邦注册局 FRG + 固定治理档 NRC/PRC/PRB)、
...
///
/// 机构码决定容器:`GenesisAdmins` 收联邦注册局与固定治理档(NRC/PRC/PRB),
...
/// 账户键全局唯一,登录时按 [Public, Private] 顺序探测命中。固定治理档(NRC/PRC/PRB,有专属桌面
/// 前端)与个人主体/个人多签不在控制台范围,返回错误拒绝。
