...
function translateErrorCode(code: string): string | null {
  const map: Record<string, string> = {
    ...
    ONCHINA_LOGIN_WALLET_CODE_INVALID:
      '管理员钱包码无效，请在公民钱包「账户详情」右上角二维码重新扫描',
    ...
    ONCHINA_LOGIN_CHALLENGE_NOT_FOUND: '登录二维码不存在或已失效，请重新扫描管理员钱包码',
    ONCHINA_LOGIN_CHALLENGE_CONSUMED: '登录二维码已使用，请重新扫描管理员钱包码',
    ONCHINA_LOGIN_SESSION_MISMATCH: '登录会话不匹配，请关闭多余页面后重新扫描管理员钱包码',
    ONCHINA_LOGIN_CHALLENGE_EXPIRED: '登录二维码已过期，请重新扫描管理员钱包码',
...
const KNOWN_ENGLISH_MESSAGES: Record<string, string> = {
  ...
  'sign request not found': '登录二维码不存在或已失效，请重新扫描管理员钱包码',
  'sign request already consumed': '登录二维码已使用，请重新扫描管理员钱包码',
  'sign request session mismatch': '登录会话不匹配，请关闭多余页面后重新扫描管理员钱包码',
  'sign request expired': '登录二维码已过期，请重新扫描管理员钱包码',
