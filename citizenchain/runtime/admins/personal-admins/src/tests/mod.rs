...
//
// personal-admins 测试只走个人多签业务,固定治理 (NRC/PRC/PRB) 不参与;
// 因此 Provider 只需要从本 pallet 读 admins / count。
...
impl votingengine::InternalAdminProvider<AccountId32> for TestInternalAdminProvider {
    ...
    fn is_pending_internal_admin(
        ...
        institution_code == PMUL
            && pallet::Pallet::<Test>::is_pending_account_admin_for_snapshot(
                institution_code,
                institution,
                who,
            )
    ...
    fn get_pending_admin_list(
        ...
        pallet::Pallet::<Test>::pending_account_admins_for_snapshot(institution_code, institution)
    }
}
...
impl votingengine::InternalAdminsLenProvider<AccountId32> for TestInternalAdminsLenProvider {
    fn admins_len(institution_code: InstitutionCode, institution: AccountId32) -> Option<u32> {
        ...
        pallet::Pallet::<Test>::active_account_admins_len(institution_code, institution)
    }
}
...
pub fn seed_active_multisig(
    ...
    let admins_ac: pallet::AdminsOf<Test> =
