...
//! 由 personal-admins / organization-manage / multisig-transfer 共用,
...
/// → `admins 模块::AdminAccounts[addr]`。
/// 与 personal-admins::PersonalMultisigQuery 对仗,multisig-transfer 通过 union
...
/// 读取 admins 模块 的 `admins` 真源,确认 `signer_pubkey` 属于该机构管理员,
