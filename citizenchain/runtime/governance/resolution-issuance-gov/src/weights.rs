...
//! 上生成，当前代码已移除这些存储项。权重数值是旧代码的过估（安全但不精确），
//! storage proof 注释不再反映实际读写路径。须在代码稳定后重新运行 benchmark。
//!
...
// 4096
// --output
// /home/runner/work/GMB/GMB/citizenchain/runtime/governance/resolution-issuance-gov/src/weights.rs
// --template
