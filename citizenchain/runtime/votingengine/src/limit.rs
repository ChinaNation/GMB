//! 全局活跃提案数量限制。
//!
//! 每个多签账户同时最多允许 Runtime 配置数量的活跃提案，
...
/// 从机构的活跃提案列表中移除指定提案。
pub fn remove_active_proposal<T: Config>(institution: T::AccountId, proposal_id: u64) {
...
/// 查询机构当前活跃提案数量。
pub fn active_proposal_count<T: Config>(institution: T::AccountId) -> u32 {
