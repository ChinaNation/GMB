...
class ReservedAccountNames {
  ...
  static const String safetyFund = '安全基金';

  /// 两和基金：制度专属账户，禁止作为自定义账户名注册。
  static const String he = '两和基金';

  /// 全部 5 个受限保留名，供遍历校验。
  static const List<String> all = <String>[main, fee, stake, safetyFund, he];
  ...
  static bool isForbidden(String name) {
    return name == stake || name == safetyFund || name == he;
  }
}
